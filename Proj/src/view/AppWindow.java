...
public class AppWindow extends JFrame{
	...
	public AppWindow(String lienCarte, String su) {	
		...
		//---------
		JSplitPane splitPaneHorizontal = new JSplitPane(JSplitPane.HORIZONTAL_SPLIT, pnlVue, pnlInfo);
        splitPaneHorizontal.setDividerLocation(largeurUtil - INFOS_LARGEUR);
